...
const team = [
  {
    ...
    bio: "Tuur zag bij tientallen KMO's hetzelfde probleem: te veel tijd kwijt aan e-mails en admin. Dus bouwde hij Aifficient om dat op te lossen.",
  ...
  },
  {
    ...
    bio: "Tibo bouwt de AI en de technologie achter het platform. Alles wat je niet ziet maar wel voelt als het gewoon werkt.",
